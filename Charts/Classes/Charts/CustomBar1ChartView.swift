...
public class CustomBar1ChartView: BarLineChartViewBase, CustomBar1ChartDataProvider
{
    ...
    internal override func initialize()
    {
        ...
        renderer = CustomBar1ChartRenderer(dataProvider: self, animator: _animator, viewPortHandler: _viewPortHandler)
        _xAxisRenderer = ChartXAxisRendererCustomBar1Chart(viewPortHandler: _viewPortHandler, xAxis: _xAxis, transformer: _leftAxisTransformer, chart: self)
        
        _highlighter = CustomBar1ChartHighlighter(chart: self)
    ...
    internal override func calcMinMax()
    {
        ...
        let barData = _data as! CustomBar1ChartData
    ...
    {
        let set = _data.getDataSetForEntry(e) as! CustomBar1ChartDataSet!
    ...
    public override var lowestVisibleXIndex: Int
        {
            ...
            let div = (step <= 1.0) ? 1.0 : step + (_data as! CustomBar1ChartData).groupSpace
    ...
    public var customBar1Data: CustomBar1ChartData? { return _data as? CustomBar1ChartData }

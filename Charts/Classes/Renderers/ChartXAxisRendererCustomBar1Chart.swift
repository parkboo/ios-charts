//
//  ChartXAxisRendererCustomBar1Chart.swift
//  Charts
//
//  Created by Booyoung Park on 2015. 11. 27..
...
public class ChartXAxisRendererCustomBar1Chart: ChartXAxisRenderer
{
    internal weak var _chart: CustomBar1ChartView!
    
    public init(viewPortHandler: ChartViewPortHandler, xAxis: ChartXAxis, transformer: ChartTransformer!, chart: CustomBar1ChartView)
    {
    ...
    internal override func drawLabels(context context: CGContext, pos: CGFloat, anchor: CGPoint)
    {
        ...
        let barData = _chart.data as! CustomBar1ChartData
